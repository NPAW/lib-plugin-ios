...
- (void)setUp {
    ...
    [given([self.mockPlugin getCustomDimension1]) willReturn:@"j"];
    [given([self.mockPlugin getCustomDimension2]) willReturn:@"l"];
    [given([self.mockPlugin getCustomDimension3]) willReturn:@"m"];
    [given([self.mockPlugin getCustomDimension4]) willReturn:@"n"];
    [given([self.mockPlugin getCustomDimension5]) willReturn:@"o"];
    [given([self.mockPlugin getCustomDimension6]) willReturn:@"p"];
    [given([self.mockPlugin getCustomDimension7]) willReturn:@"q"];
    [given([self.mockPlugin getCustomDimension8]) willReturn:@"r"];
    [given([self.mockPlugin getCustomDimension9]) willReturn:@"s"];
    [given([self.mockPlugin getCustomDimension10]) willReturn:@"t"];
