...
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_HDS;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_HLS;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_MSS;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_DASH;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_RTMP;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_RTP;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_RTSP;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_HLS_TS;
FOUNDATION_EXPORT NSString * const STREAM_PROTOCOL_HLS_FMP4;
