...
- (void)encodeWithCoder:(NSCoder *)coder {
    ...
    [coder encodeObject:self.extraparam1 forKey:@"customDimension1"];
    [coder encodeObject:self.extraparam2 forKey:@"customDimension2"];
    [coder encodeObject:self.extraparam3 forKey:@"customDimension3"];
    [coder encodeObject:self.extraparam4 forKey:@"customDimension4"];
    [coder encodeObject:self.extraparam5 forKey:@"customDimension5"];
    [coder encodeObject:self.extraparam6 forKey:@"customDimension6"];
    [coder encodeObject:self.extraparam7 forKey:@"customDimension7"];
    [coder encodeObject:self.extraparam8 forKey:@"customDimension8"];
    [coder encodeObject:self.extraparam9 forKey:@"customDimension9"];
    [coder encodeObject:self.extraparam10 forKey:@"customDimension10"];
    [coder encodeObject:self.extraparam11 forKey:@"customDimension11"];
    [coder encodeObject:self.extraparam12 forKey:@"customDimension12"];
    [coder encodeObject:self.extraparam13 forKey:@"customDimension13"];
    [coder encodeObject:self.extraparam14 forKey:@"customDimension14"];
    [coder encodeObject:self.extraparam15 forKey:@"customDimension15"];
    [coder encodeObject:self.extraparam16 forKey:@"customDimension16"];
    [coder encodeObject:self.extraparam17 forKey:@"customDimension17"];
    [coder encodeObject:self.extraparam18 forKey:@"customDimension18"];
    [coder encodeObject:self.extraparam19 forKey:@"customDimension19"];
    [coder encodeObject:self.extraparam20 forKey:@"customDimension20"];
    [coder encodeObject:self.adExtraparam1 forKey:@"adCustomDimension1"];
    [coder encodeObject:self.adExtraparam2 forKey:@"adCustomDimension2"];
    [coder encodeObject:self.adExtraparam3 forKey:@"adCustomDimension3"];
    [coder encodeObject:self.adExtraparam4 forKey:@"adCustomDimension4"];
    [coder encodeObject:self.adExtraparam5 forKey:@"adCustomDimension5"];
    [coder encodeObject:self.adExtraparam6 forKey:@"adCustomDimension6"];
    [coder encodeObject:self.adExtraparam7 forKey:@"adCustomDimension7"];
    [coder encodeObject:self.adExtraparam8 forKey:@"adCustomDimension8"];
    [coder encodeObject:self.adExtraparam9 forKey:@"adCustomDimension9"];
    [coder encodeObject:self.adExtraparam10 forKey:@"adCustomDimension10"];
}
