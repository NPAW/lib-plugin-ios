...
- (nullable instancetype)initWithCoder:(NSCoder *)decoder
{
    ...
    if (self) {
        ...
        self.forceInit = [[decoder decodeObjectForKey:YBOPTIONS_KEY_FORCEINIT] isEqualToValue:@YES];
        ...
        self.deviceIsAnonymous = [[decoder decodeObjectForKey:YBOPTIONS_KEY_DEVICE_IS_ANONYMOUS] isEqualToValue:@YES];
        ...
        self.autoDetectBackground = [[decoder decodeObjectForKey:YBOPTIONS_KEY_BACKGROUND] isEqualToValue:@YES];
        self.offline = [[decoder decodeObjectForKey:YBOPTIONS_KEY_OFFLINE] isEqualToValue:@YES];
        ...
        self.waitForMetadata = [[decoder decodeObjectForKey:YBOPTIONS_KEY_WAIT_METADATA] isEqualToValue:@YES];
...
- (void)encodeWithCoder:(NSCoder *)coder {
    ...
    [coder encodeObject:@(self.deviceIsAnonymous) forKey:YBOPTIONS_KEY_DEVICE_IS_ANONYMOUS];
