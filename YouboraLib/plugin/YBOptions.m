...
- (nullable instancetype)initWithCoder:(NSCoder *)decoder
{
    ...
    @try {
        if (self) {
            self.enabled = [decoder decodeBoolForKey:YBOPTIONS_KEY_ENABLED];
            self.httpSecure = [decoder decodeBoolForKey:YBOPTIONS_KEY_HTTP_SECURE];
            ...
            self.parseHls = [decoder decodeBoolForKey:YBOPTIONS_KEY_PARSE_HLS];
            self.parseCdnNameHeader = [decoder decodeObjectForKey:YBOPTIONS_KEY_PARSE_CDN_NAME_HEADER];
            self.parseCdnNode = [decoder decodeBoolForKey:YBOPTIONS_KEY_PARSE_CDN_NODE];
            self.parseCdnNodeList = [decoder decodeObjectForKey:YBOPTIONS_KEY_PARSE_CDN_NODE_LIST];
            self.parseLocationHeader = [decoder decodeBoolForKey:YBOPTIONS_KEY_PARSE_LOCATION_HEADER];
            ...
            self.forceInit = [decoder decodeBoolForKey:YBOPTIONS_KEY_FORCEINIT];
            ...
            self.deviceIsAnonymous = [decoder decodeBoolForKey:YBOPTIONS_KEY_DEVICE_IS_ANONYMOUS];
            ...
            self.adCreativeId = [decoder decodeObjectForKey:YBOPTIONS_KEY_AD_CREATIVEID];
            self.adProvider = [decoder decodeObjectForKey:YBOPTIONS_KEY_AD_PROVIDER];
            self.autoDetectBackground = [decoder decodeBoolForKey:YBOPTIONS_KEY_BACKGROUND];
            self.offline = [decoder decodeBoolForKey:YBOPTIONS_KEY_OFFLINE];
            ...
            self.waitForMetadata = [decoder decodeBoolForKey:YBOPTIONS_KEY_WAIT_METADATA] ;
...
- (void)encodeWithCoder:(NSCoder *)coder {
    [coder encodeBool:self.enabled forKey:YBOPTIONS_KEY_ENABLED];
    [coder encodeBool:self.httpSecure forKey:YBOPTIONS_KEY_HTTP_SECURE];
    ...
    [coder encodeBool:self.parseHls forKey:YBOPTIONS_KEY_PARSE_HLS];
    [coder encodeObject:self.parseCdnNameHeader forKey:YBOPTIONS_KEY_PARSE_CDN_NAME_HEADER];
    [coder encodeBool:self.parseCdnNode forKey:YBOPTIONS_KEY_PARSE_CDN_NODE];
    [coder encodeObject:self.parseCdnNodeList forKey:YBOPTIONS_KEY_PARSE_CDN_NODE_LIST];
    [coder encodeBool:self.parseLocationHeader forKey:YBOPTIONS_KEY_PARSE_LOCATION_HEADER];
    ...
    [coder encodeBool:self.forceInit forKey:YBOPTIONS_KEY_FORCEINIT];
    ...
    [coder encodeBool:self.deviceIsAnonymous forKey:YBOPTIONS_KEY_DEVICE_IS_ANONYMOUS];
    ...
    [coder encodeObject:self.adCreativeId forKey:YBOPTIONS_KEY_AD_CREATIVEID];
    [coder encodeObject:self.adProvider forKey:YBOPTIONS_KEY_AD_PROVIDER];
    [coder encodeBool:self.autoDetectBackground forKey:YBOPTIONS_KEY_BACKGROUND];
    [coder encodeBool:self.offline forKey:YBOPTIONS_KEY_OFFLINE];
    ...
    [coder encodeBool:self.waitForMetadata forKey:YBOPTIONS_KEY_WAIT_METADATA];
...
- (NSDictionary *) toDictionary {
    ...
    [dict setValue:@(self.deviceIsAnonymous) forKey:YBOPTIONS_KEY_DEVICE_IS_ANONYMOUS];
    ...
    [dict setValue:self.adCreativeId forKey:YBOPTIONS_KEY_AD_CREATIVEID];
    [dict setValue:self.adProvider forKey:YBOPTIONS_KEY_AD_PROVIDER];
