...
- (nullable instancetype)initWithCoder:(NSCoder *)decoder
{
    ...
    if (self) {
        ...
        self.sendTotalBytes = [decoder decodeBoolForKey:YBOptionKeys.sendTotalBytes];
...
- (void)encodeWithCoder:(NSCoder *)coder {
    ...
    [coder encodeBool:self.sendTotalBytes forKey:YBOptionKeys.sendTotalBytes];
